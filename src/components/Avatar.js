  ...
  return (
    <div className="margin30">
      ...
      <div className="marginT20">
        ...
        <div className="padT10 width100 textcenter avatarInto oh">
          <FadeIn className="lh2em" style={{ animationDelay: '0.15s' }}>front-end developer @<a href="https://www.microsoft.com/" target="_blank" rel="noopener noreferrer"><span className="linkHand">Microsoft</span></a></FadeIn>
        </div>
        <div className="padT10 width100 textcenter avatarInto oh">
