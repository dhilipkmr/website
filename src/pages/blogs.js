              ...
              <div className="posAbs transCenter mw90" style={{ 'maxWidth': '100%'}}>
                {post &&
                  <Link className=" " to={post.path}>
                    <div className="op0 opAnimator white padB10 fb fs35 lh2em textcenter " style={{ textAlign: 'left', textTransform: 'uppercase', animationDelay: '0.3s'}}>{post.smallTitle}</div>
